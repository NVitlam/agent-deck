...
whole". Measured on this corpus after regenerating, 246 tool parts and 246 tool nodes: **14 `true`,
205 `false`, 27 absent** in the database, and `"truncated": true` / `false` / `null` appear 14 / 205 / 27
